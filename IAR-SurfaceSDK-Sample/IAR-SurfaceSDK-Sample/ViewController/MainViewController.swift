...
//
//  Created by Rogerio on 2022-01-05.
//
...
class MainViewController: UIViewController {
    ...
    private func setupLicense() {
        ...
        print("License: '\(licenseString)'. Is valid? \(isLicenseValid)")
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch dataItem.ID {
            ...
            case .onDemandMarkers:
                performSegue(withIdentifier: "segueOnDemand", sender: self)
            case .nfcWrite:
                performSegue(withIdentifier: "segueNFCWrite", sender: self)
            case .nfcRead:
